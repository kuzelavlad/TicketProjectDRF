    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='event', to='playground.company', verbose_name='Организатор')),
                ('sponsors', models.ManyToManyField(related_name='+', to='playground.company', verbose_name='Спонсоры')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='playground.event', verbose_name='Название мероприятия')),
